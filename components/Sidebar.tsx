          ...
          <VStack space="xs" px="$3">
            ...
            {item.children.map((child, childIndex) => (
              <Pressable
                ...
                _hover={{ bg: isActive(child.path) ? '$primary500' : '$backgroundDark800' }}
              >
  ...
  const renderNavItem = (item: NavItem, index: number) => {
            ...
            >
              <Box position="relative">
                <Icon
                  ...
                  name={item.icon}
                  size="lg"
                  color={isSubmenuOpen ? "$primary500" : (isExpanded ? "$textLight200" : "$textLight400")}
                />
    ...
    return (
      <Pressable
        ...
        _hover={{ bg: itemActive ? '$primary500' : '$backgroundDark800' }}
        alignItems="center"
        justifyContent={isSidebarCollapsed ? 'center' : 'flex-start'}
      >
        <Icon
